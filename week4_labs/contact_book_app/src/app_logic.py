            ...
            ft.ListTile(
                ...
                trailing=ft.PopupMenuButton(
                    ...
                    items=[
                        ...
                        ft.PopupMenuItem(
                            text="Delete",
                            icon=ft.Icons.DELETE, on_click=lambda _, cid=contact_id: delete_contact(page, cid, db_conn, contacts_list_view)
                        ),
                    ],
                ),
            )
...
def open_edit_dialog(page, contact, db_conn, contacts_list_view):
    ...
    dialog = ft.AlertDialog(
        ...
        actions=[
            ft.TextButton("Cancel", on_click=lambda e: setattr(dialog, 'open', False) or page.update()), ft.TextButton("Save", on_click=save_and_close),
        ],
    )
    page.open(dialog)